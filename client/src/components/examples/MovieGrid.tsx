...
export default function MovieGridExample() {
	return <MovieGrid title="Popular en CineStream" movies={mockMovies} onMovieClick={(id) => console.log("Movie clicked:", id)} onToggleFavorite={(id) => console.log("Toggle favorite:", id)} />;
}
