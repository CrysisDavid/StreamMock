...
import { useMovie, usePopularMovies } from "@/hooks/useMovies";
...
const PopularList = () => {
	...
	const { data: movies, isLoading, isError, error, refetch } = usePopularMovies(50);
		...
		return (
			<div className="min-h-screen flex items-center justify-center">
				<div className="text-center">
					...
					<p className="mt-4 text-muted-foreground">Cargando películas populares...</p>
				</div>
			</div>
		);
	}
			...
			<div className="min-h-screen">
				...
				<div className="flex items-center justify-center min-h-[60vh]">
					<div className="text-center max-w-md px-4">
						...
						<p className="text-muted-foreground mb-6">{(error as any)?.message || "No se pudieron cargar las películas populares. Por favor, verifica tu conexión."}</p>
	...
	return (
		<div className="min-h-screen">
			...
			<div className="space-y-12 py-12">
				<MovieGrid title="Películas Populares" movies={popularMovies} onMovieClick={handleMovieClick} onToggleFavorite={toggleFavorite} />
			</div>
