...
- Solo el creador podrá editar o eliminar la película posteriormente
...
#### Restricciones:
- Solo el usuario que creó la película puede actualizarla
- Error 403 si intentas actualizar una película de otro usuario
...
#### Errors:
- **401**: Token inválido o faltante
- **403**: No tienes permiso para actualizar esta película
- **404**: Película no encontrada
...
#### Restricciones:
- Solo el usuario que creó la película puede eliminarla
- Error 403 si intentas eliminar una película de otro usuario
- También se eliminan todos los favoritos asociados a la película

#### Response (204): Sin contenido

#### Errors:
- **401**: Token inválido o faltante
- **403**: No tienes permiso para eliminar esta película
- **404**: Película no encontrada
...
### 👤 Películas por Usuario Creador
**GET** `/api/peliculas/usuario/{usuario_id}`
...
#### Restricciones:
- Solo puedes ver tus propias películas creadas
- El `usuario_id` debe coincidir con el usuario autenticado
...
#### Errors:
- **401**: Token inválido o faltante
- **403**: No tienes permiso para ver las películas de otro usuario
- **404**: Usuario no encontrado
...
🔒 **Requiere autenticación - Solo el creador puede subir/cambiar imagen**
...
- **Tamaño máximo**: 5MB
- Solo el creador de la película puede subir su imagen
...
- **401**: Token inválido o faltante
- **403**: No tienes permiso para subir imagen a esta película
- **404**: Película no encontrada
...
🔒 **Requiere autenticación - Solo el creador puede eliminar imagen**
...
#### Restricciones:
- Solo el creador de la película puede eliminar su imagen

#### Response (204): Sin contenido

#### Errors:
- **401**: Token inválido o faltante
- **403**: No tienes permiso para eliminar la imagen de esta película
- **404**: Película no encontrada o no tiene imagen
...
#### Restricciones:
- El `id_usuario` debe coincidir con el usuario autenticado
- No puedes crear favoritos para otros usuarios
...
- **401**: Token inválido o faltante
- **403**: No puedes crear favoritos para otros usuarios
- **404**: Usuario o película no encontrada
...
🔒 **Requiere autenticación - Solo puedes eliminar tus propios favoritos**
...
#### Errors:
- **401**: Token inválido o faltante
- **403**: No tienes permiso para eliminar este favorito
...
7. **Propiedad de Recursos**: 
   - Solo puedes editar/eliminar películas que tú creaste
   - Solo puedes gestionar tus propios favoritos
   - El `user_id` se asigna automáticamente al crear películas
8. **Tokens JWT**: 
   - Access tokens expiran en 60 minutos (desarrollo)
   - Refresh tokens expiran en 30 días
   - Usa el endpoint `/api/auth/refresh` para renovar tokens expirados
